...
import com.blackfat.common.utils.base.annotation.NotNull;
...
public class MapUtil {
     ...
     */
    public static <K, V> V putIfAbsentWithFinalValue(@NotNull final java.util.concurrent.ConcurrentMap<K, V> map, final K key,
                                                     final V value) {
     ...
     */
    public static <K, V> V createIfAbsent(@NotNull final java.util.concurrent.ConcurrentMap<K, V> map, final K key,
     ...
     * 同时初始化元素.
     */
    public static <K, V> HashMap<K, V> newHashMap(@NotNull final java.util.List<K> keys, @NotNull final java.util.List<V> values) {
     ...
     */
    public static <C, K extends C, V> TreeMap<K, V> newSortedMap(@Nullable java.util.Comparator<C> comparator) {
