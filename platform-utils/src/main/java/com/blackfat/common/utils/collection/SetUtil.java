...
import com.blackfat.common.utils.collection.type.primitive.ConcurrentHashSet;
...
public class SetUtil {
     ...
     */
    public static <T> TreeSet<T> newSortedSet(@Nullable java.util.Comparator<? super T> comparator) {
