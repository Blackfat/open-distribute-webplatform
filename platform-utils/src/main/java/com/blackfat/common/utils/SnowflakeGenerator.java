...
public class SnowflakeGenerator {
    ...
    /**
     * data cfg number the process running on, its value can't be modified after initialization.
     * <p>
    ...
    // /**
    // * @param datacenterId
    // * data cfg number the process running on, value range: [0,31]
    // * @param workerId
